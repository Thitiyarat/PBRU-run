...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText userEditText,passwordEditTexr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passwordEditTexr = (EditText) findViewById(R.id.editText5);
    ...
    public void clickSignIn(View view) {
        ...
        passwordString = passwordEditTexr.getText().toString().trim();
